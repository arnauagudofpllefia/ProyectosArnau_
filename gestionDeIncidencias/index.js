...
//Eventos para detectar cunado cambia y llamar a la funcion para qu efiltre
...
function filtrarIncidencias() {
    ...
    // Estadísticas dinamicas para que muestre cuantas incidencias hay
    ...
    //Mostrar las incidencias filtradas por estado y prioridad
    let casilla1 = "";
    for (let i = 0; i < incidenciasFiltradas.length; i++) {
...
function obrirModalNova() {
    ...
    const modalNovaIncidencia = document.querySelector('#modalNovaIncidencia')

    btnNovaInc.addEventListener('click', function () {
        // Usar la API de Bootstrap 5 para mostrar el modal
        const modal = new bootstrap.Modal(modalNovaIncidencia)
        modal.show()
...
function eliminarIncidencia(){
     ...
     tabla.addEventListener("click", (e) => {
        // Verifica si el click fue en un boton de eliminar
